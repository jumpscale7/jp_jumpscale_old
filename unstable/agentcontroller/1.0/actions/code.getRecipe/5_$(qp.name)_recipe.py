def main(j,args,params,tags,tasklet):
    ...
    recipe.add(repo, "apps/agentcontroller", "apps/agentcontroller",type=None, branch='')  #when type=config then this entry will not be linked when doing codelink but will be copied because is config info
