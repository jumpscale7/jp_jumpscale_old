...
def main(j,jp):
    ...
    jp._copyFiles(subdir=fwtype,destination="/etc/shorewall",applyhrd=True) #  will copy files from subdir called root of platforms to root of system (carefull), will also use templateEngine for hrd 
