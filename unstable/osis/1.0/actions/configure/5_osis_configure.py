def main(j,args,params,tags,tasklet):
    ...
    j.tools.circus.manager.addProcess('osis', cmd, args, priority=2, workingdir=workingdir, \
        before_start='JumpScale.baselib.circus.CircusManager.checkPort')
    ...
    print "test if osis got strarted by doing a port test"
