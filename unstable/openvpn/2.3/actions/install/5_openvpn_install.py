def main(j,args,params,tags,tasklet):
    ...
    ##args.qp.copyFiles(subdir="root",destination="/",applyhrd=True) #  will copy files from subdir called root of platforms to root of system (carefull), will also use templateEngine for hrd 
