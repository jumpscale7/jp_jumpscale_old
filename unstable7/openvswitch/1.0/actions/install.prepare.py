def main(j,jp):
    ...
    j.system.platform.ubuntu.install("openvswitch-datapath-dkms")
    j.system.platform.ubuntu.install("openvswitch-switch")
    j.system.platform.ubuntu.install("python-openvswitch")
